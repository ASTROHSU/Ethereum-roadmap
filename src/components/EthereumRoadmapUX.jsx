...
const upgradeTimeline = [
  ...
  { name: 'Berlin', nameZh: 'Gas 效率小調整', date: '2021 年 4 月', status: 'completed', note: '優化對某些區塊鏈操作的 Gas 費用，並修補數個安全漏洞。' },
  { name: 'Muir Glacier', nameZh: '難度炸彈延遲', date: '2020 年 1 月', status: 'completed', note: '再次延遲難度炸彈，讓 PoW 挖礦能維持到 The Merge。' },
  { name: 'Istanbul', nameZh: '多個 EIP 整備升級', date: '2019 年 12 月', status: 'completed', note: '改善與 Zcash 的互操作性，優化若干 Gas 費用，強化 L2 Rollup 基礎。' },
  { name: 'Constantinople / St. Petersburg', nameZh: '效率與經濟模型調整', date: '2019 年 2 月', status: 'completed', note: '區塊獎勵減少、Gas 優化，並修除一個重大安全漏洞。' },
  { name: 'Byzantium', nameZh: 'Metropolis 第一階段', date: '2017 年 10 月', status: 'completed', note: '引入 ZK 隱私預備計算、地址可讀餘額等，奠定後續 DeFi 基礎。' },
  { name: 'Homestead', nameZh: '第一個穩定版本', date: '2016 年 3 月', status: 'completed', note: '移除早期可被利用的安全說明，以太坊正式進入穩定可用階段。' },
  { name: 'Frontier', nameZh: '創世區塊 / 初始啟動', date: '2015 年 7 月', status: 'completed', note: '以太坊公主網正式發佈，當時僅限開發者使用，尚無圖形介面。' },
];
...
const DATA_SOURCES = [
  {
    label: 'Ethereum.org 路線圖（Strawmap）',
    desc: '以太坊官方絷護的路線圖視覺化頁面，各大面向與進度的原始參考。',
  ...
  {
    label: 'EIPs 官方資料庫',
    desc: '所有以太坊改進提案（EIP）的原始文件，想石菜具體规格的可在這裡查。',
    url: 'https://eips.ethereum.org/',
  },
  {
    label: 'Ethereum Foundation 部落格',
    desc: '各刧升級發佈前後的官方公告與技術解說，內容最可信的一手資料。',
